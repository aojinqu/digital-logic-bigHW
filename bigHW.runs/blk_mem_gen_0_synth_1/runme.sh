...
HD_PWD='D:/users/bigHW/bigHW.runs/blk_mem_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_0.tcl
